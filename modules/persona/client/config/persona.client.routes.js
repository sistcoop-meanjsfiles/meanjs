	...
	function ($stateProvider, $urlRouterProvider) {
		...
		$stateProvider
			.state('persona', {
				abstract: true,
				url: '/persona',
				templateUrl: 'modules/persona/client/views/_body.html',
				controller: 'PersonaController'
			})
			.state('persona.home', {
				url: '/home',
				templateUrl: 'modules/persona/client/views/index.html',
				ncyBreadcrumb: {
					label: 'Index'
				}
			})
			...
			.state('persona.app.administracion.documento.buscar', {
				url: '/buscar',
				templateUrl: 'modules/persona/client/views/tipoDocumento/form-buscar-tipoDocumento.html',
			...
			.state('persona.app.administracion.documento.crear', {
				url: '/crear',
				templateUrl: 'modules/persona/client/views/tipoDocumento/form-crear-tipoDocumento.html',
			...
			.state('persona.app.administracion.documento.editar', {
				...
				templateUrl: 'modules/persona/client/views/tipoDocumento/form-editar-tipoDocumento.html',
				resolve: {
					loggedin: function ($q, $timeout, $http, $location, Auth) {
						return checkUserRole('ver-documentos', $q, $timeout, $http, $location, Auth);
					},
			...
			.state('persona.app.persona.natural.buscar', {
				url: '/buscar',
				templateUrl: 'modules/persona/client/views/natural/form-buscar-personaNatural.html',
				...
				templateUrl: 'modules/persona/client/views/natural/form-crear-personaNatural.html',
				...
				url: '/resumen',
				templateUrl: 'modules/persona/client/views/natural/form-editar-resumen.html',
				...
				templateUrl: 'modules/persona/client/views/natural/form-editar-datosPrincipales.html',
				...
				templateUrl: 'modules/persona/client/views/natural/form-editar-datosAdicionales.html',
			...
			.state('persona.app.persona.juridica.buscar', {
				url: '/buscar',
				templateUrl: 'modules/persona/client/views/juridica/form-buscar-personaJuridica.html',
				...
				url: '/crear?tipoDocumento&numeroDocumento',
				templateUrl: 'modules/persona/client/views/juridica/form-crear-personaJuridica.html',
				...
				url: '/datosPrincipales',
				templateUrl: 'modules/persona/client/views/juridica/form-crear-datosPrincipales.html',
				...
				url: '/representante',
				templateUrl: 'modules/persona/client/views/juridica/form-crear-representante.html',
			...
			.state('persona.app.persona.juridica.editar', {
				...
				url: '/resumen',
				templateUrl: 'modules/persona/client/views/juridica/form-editar-resumen.html',
				...
				url: '/datosPrincipales',
				templateUrl: 'modules/persona/client/views/juridica/form-editar-datosPrincipales.html',
				...
				url: '/datosAdicionales',
				templateUrl: 'modules/persona/client/views/juridica/form-editar-datosAdicionales.html',
				...
				url: '/representante',
				templateUrl: 'modules/persona/client/views/juridica/form-editar-representante.html',
				...
				url: '/crearAccionista',
				templateUrl: 'modules/persona/client/views/juridica/form-editar-accionistas.html',
