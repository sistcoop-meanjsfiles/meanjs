...
/* jshint -W098 */
angular.module('cooperativa').controller('Cooperativa.Caja.BovedaCaja.Historial.TransaccionBovedaCaja.EditarController',
	function ($scope, $state, toastr, transaccion) {
